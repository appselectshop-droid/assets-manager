    ...
    <PortalLayout activeNav="manuales">
      ...
      <section id="reportar-ticket" className={styles.section}>
        ...
        <ul>
          ...
          <li><strong>Adjuntar evidencia</strong> (recomendado, no obligatorio): una foto o captura de pantalla, o un PDF — hasta 15MB. Ayuda mucho a que Sistemas entienda tu problema sin tener que adivinar.</li>
        </ul>
      ...
      <section id="faq" className={styles.section}>
        ...
        <Faq q="¿Puedo adjuntar una foto o PDF como evidencia del problema?">
          Sí, es opcional (excepto en Alta de Proveedores, donde es obligatorio) y acepta imágenes o
          PDF de hasta 15MB — aunque no sea obligatorio, se recomienda mucho hacerlo: ayuda a
          Sistemas a entender tu problema sin tener que adivinar.
        </Faq>
